  ...
  <div class="row justify-content-center">
    <div class="col-md-5">
      ...
      <form method="POST" action="{{ route('mypage') }}">
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between">
            <label for="postal_code" class="text-md-left tabelog-edit-user-info-label">郵便番号</label>
          </div>
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between">
            <label for="address" class="text-md-left tabelog-edit-user-info-label">住所</label>
          </div>
          <div class="collapse show editUserPhone">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn tabelog-delete-submit-button">退会する</button>
                </div>
              </div>
            </div>
          </div>
